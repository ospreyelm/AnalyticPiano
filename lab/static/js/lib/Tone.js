...
***************************************************************************** */ this
      ...
      class Zo {
        constructor(t, e) {
          (this.id = Zo._eventId++), (this._remainderTime = 0);
      ...
      class Xo extends Zo {
        ...
        _createEvent() {
          return Fi(this._nextTick, this.floatTime + this.duration)
        ...
        _createEvents(t) {
          Fi(this._nextTick + this._interval, this.floatTime + this.duration) &&
