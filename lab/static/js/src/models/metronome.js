define(["jquery", "lodash", "microevent", "app/config"], function (
  $,
  _,
  MicroEvent,
  Config
  ...
  _.extend(Metronome.prototype, {
    ...
    init: function (tempo, tockDelayFraction) {
       ...
       * @protected
       */
      this.tockDelay = this.calculateTockDelay(
        this.tempo,
        this.tockDelayFraction
      );
      /**
    ...
    _scheduleTockInterval: function () {
      if (this.tockIntervalID === null) {
        this.tockTimeoutID = window.setTimeout(
          this._startTockInterval,
          this.tockDelay
        );
      }
    },
