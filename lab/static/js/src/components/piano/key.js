 ...
 * Piano key UI.
 */
define(["lodash", "app/components/component"], function (_, Component) {
  "use strict";
  ...
  WhitePianoKey.prototype.defaultKeyColorMap = _.clone(
    WhitePianoKey.prototype.keyColorMap
  );
  ...
  BlackPianoKey.prototype.defaultKeyColorMap = _.clone(
    BlackPianoKey.prototype.keyColorMap
  );
