...
], function (_, Config, EVENTS, Component, ExerciseContext) {
  /**
  ...
  _.extend(MidiComponent.prototype, {
    ...
    initComponent: function () {
      ...
      if (navigator.requestMIDIAccess === undefined) {
        ...
        navigator
          .requestMIDIAccess()
          .then(this.onWebMIDIInit, this.onWebMIDIError);
    },
    /**
    ...
    onMidiMessage: function (msg) {
      ...
      if (
        MIDI_MSG_MAP.NOTE_ON.indexOf(command) !== -1 &&
        (!msg.data[2] || msg.data[2] == 0)
      ) {
    ...
    onNoteChange: function (noteState, noteNumber, extra) {
      ...
      var command =
        noteState === "on"
          ? MIDI_MSG_MAP.NOTE_ON[channel_idx]
