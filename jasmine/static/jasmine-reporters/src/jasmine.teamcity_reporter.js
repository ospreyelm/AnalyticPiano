    ...
    reportSuiteResults: function (suite) {
      ...
      this.log(
        "##teamcity[testSuiteStarted name='" +
          this.escapeTeamcityString(description) +
          "']"
      );
        ...
        if (spec.description) {
          outerThis.log(
            "##teamcity[testStarted name='" +
              outerThis.escapeTeamcityString(spec.description) +
            ...
            if (!result.passed_) {
              outerThis.log(
                "##teamcity[testFailed name='" +
                  ...
                  outerThis.escapeTeamcityString(result.trace.stack) +
                  "']"
              );
            }
          };
      ...
      this.log(
        "##teamcity[testSuiteFinished name='" +
          outerThis.escapeTeamcityString(description) +
          "']"
      );
    },
