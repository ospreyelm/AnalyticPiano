    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', django.contrib.postgres.fields.jsonb.JSONField(default=apps.exercises.models.get_default_data, verbose_name='Raw Data')),
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created at')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Updated at')),
                ('playlist', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='performance_data', to='exercises.Playlist')),
                ('supervisor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='supervisor_performance_data', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='performance_data', to=settings.AUTH_USER_MODEL)),
            ],
            options={
