...
def playlist_performance_view(request, playlist_id):
    ...
    for d in data:
        ...
        [d.update(**{exercise['id']:
            ...
            f'{"" if (( isinstance(exercise["exercise_error_tally"], int) and exercise["exercise_error_tally"] > 0 ) or not isinstance(exercise["exercise_mean_tempo"], int)) else exercise["exercise_mean_tempo"]}'
